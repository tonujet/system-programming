...
namespace Company {
    ...
    UserInterface::UserInterface(OwnerView *ownerView, CarView *carView, TaxiCompany *taxiCompany)
        ...
        optionHandlers = {
                {1, [](UserInterface *ui) { ui->onFirstOption(); }},
                {2, [](UserInterface *ui) { ui->onSecondOption(); }},
                {3, [](UserInterface *ui) { ui->onThirdOption(); }},
                {4, [](UserInterface *ui) { ui->onFourthOption(); }},
                {5, [](UserInterface *ui) { ui->onFifthOption(); }},
                {6, [](UserInterface *ui) { ui->onSixthOption(); }},
                {7, [](UserInterface *ui) { ui->onSeventhOption(); }},
                {8, [](UserInterface *ui) { ui->onEighthOption(); }}
        };
    }
    ...
    void UserInterface::onFirstOption() {
        ...
        if (car != nullptr) {
            if (type == 1) carView->printShortInfo(car);
            else carView->printFullInfo(car);
        } else {
    ...
    void UserInterface::viewCars(vector<Car *> *cars) {
        ...
        int type = selectCarPrintingType();
        if (type == 1) carView->printShortInfo(cars);
        else carView->printFullInfo(cars);
    }
